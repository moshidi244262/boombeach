...
window.GameDataDB['微波烤炉'] = {
    name: '微波烤炉',
    img: 'images/防御建筑图片/微波烤炉/MicrowavrIII.webp',
    desc: '微波烤炉是一款强大的近战防御原型武器。只要敌军踏入它的攻击范围（7格内），它就会以极快的频率（0.2秒）对范围内的所有单位同时造成持续性伤害。',
    // 基础属性网格
    baseStats: [
        { label: '建筑面积', val: '3×3' },
        { label: '攻击范围', val: '7' },
        { label: '攻击速度', val: '0.2s' },
        { label: '特殊技能', val: '同时伤害范围内所有单位' },
    ...
    // 微波烤炉等级数据表 (倒序排列)
    levels: [
        { lv: 3, hp: 50000, dmg: 700, perDmg: 140, fuse: 5, gear: 3, rod: 0, cap: 7, time: '12h', reqLv: 4 },
        { lv: 2, hp: 30000, dmg: 500, perDmg: 100, fuse: 4, gear: 2, rod: 0, cap: 6, time: '4h', reqLv: 3 },
        { lv: 1, hp: 20000, dmg: 300, perDmg: 60, fuse: 3, gear: 2, rod: 0, cap: 4, time: '1h', reqLv: 2 }
    ],

    // 动态追加的模块 (外观图集)
    extraHtml: `
        <h3 style="margin-top:32px; margin-bottom:16px; color:#1f2937;">微波烤炉外观图片</h3>
        <div class="grid-container" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 16px;">
            ${[
                { name: '微波烤炉 Ⅰ', img: 'images/防御建筑图片/微波烤炉/MicrowavrI.webp' },
                { name: '微波烤炉 Ⅱ', img: 'images/防御建筑图片/微波烤炉/MicrowavrII.webp' },
                { name: '微波烤炉 Ⅲ', img: 'images/防御建筑图片/微波烤炉/MicrowavrIII.webp' }
            ].map(imgObj => `
