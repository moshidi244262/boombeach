...
window.GameDataDB['超级步兵'] = {
    name: '超级步兵',
    img: 'images/兵种/超级兵种/wenhao.webp',
    desc: '拥有强化属性的超级步兵，更快的攻击频率使其能在战场上释放猛烈的火力。',
    ...
    levels: [
        { building: '超级士兵大桶', ability: '属性提升攻击速度提升', bHp: '10,000', tHp: '12,500', dps: '1,200', speed: '120', dmg: '290', interval: '0.1S' },
        { building: '惊喜蛋糕', ability: '属性提升攻击速度提升', bHp: '20,000', tHp: '12,500', dps: '1,200', speed: '120', dmg: '290', interval: '0.1S' }
    ]
};