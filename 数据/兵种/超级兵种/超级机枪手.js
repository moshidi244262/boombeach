...
window.GameDataDB['超级机枪手'] = {
    name: '超级机枪手',
    img: 'images/兵种/超级兵种/wenhao.webp',
    desc: '超级机枪手不仅身板更加坚实，密集的火力输出能对近距离目标造成毁灭性的打击。',
    ...
    levels: [
        { building: '超级士兵大桶', ability: '属性提升', bHp: '20,000', tHp: '43,000', dps: '800', speed: '80', dmg: '230', interval: '0.1S' },
        { building: '惊喜蛋糕', ability: '属性提升', bHp: '20,000', tHp: '43,000', dps: '800', speed: '80', dmg: '230', interval: '0.1S' }
    ]
};